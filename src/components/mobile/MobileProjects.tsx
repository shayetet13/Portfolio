...
const MobileProjects = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Mobile App",
      subtitle: "แอปมือถือ",
      description: "ลง Custom ROM, Root, Unlock Bootloader, แก้ปัญหาเครื่อง Brick",
      services: ["Custom ROM", "Unlock Bootloader", "Root Device", "Fix Brick"],
      tech: ["Fastboot", "ADB", "Odin", "TWRP"],
...
<p className="text-lg max-w-2xl mx-auto mb-12 bg-gradient-to-br from-yellow-300 via-lime-400 to-green-400 bg-clip-text text-transparent font-bold leading-relaxed animate-gradient bg-300%">
  "ถ้าคุณกำลังหา Dev ที่ไม่ทิ้งงาน ไม่หนีหาย และยังทำให้เว็บหรือแอปคุณดูโคตรเท่ คุณมาถูกที่แล้ว! เราร้บพัฒนา Web App, Website, iOS, Android ด้วยเทคโนโลยีทันสมัย โค้ดสะอาด วิ่งลื่น พร้อมดูแลตั้งแต่วันแรกยันวัน Deploy บอกเลย...เราไม่เท!"
</p>
        </motion.div>
